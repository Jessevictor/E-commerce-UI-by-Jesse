...
<head>
    ...
    <style>
       ...
       .container{background:rgb(255, 165, 48); border-radius: 10px;}
       .carousel-inner{border-radius:0 10px 10px 0;}
       .carousel-caption{text-align:left; left:20%;}
       .login-sec{padding: 50px 30px; position:relative;}
       .login-sec .copy-text{position:absolute; width:80%; bottom:20px; font-size:13px; text-align:center;}
       .login-sec .copy-text i{color:#1f1916;}
       .login-sec .copy-text a{color:#ffa600;}
       .login-sec h2{margin-bottom:30px; font-weight:800; font-size:30px; color: #181714;}
       ...
       .btn-login{background: #1d1b19; color:#fff; font-weight:600;}
